...
public class RenderAtmosphericCompressor extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float f) {
		...
		TileEntityAtmosphericCompressor atmo = (TileEntityAtmosphericCompressor) tileEntity;
