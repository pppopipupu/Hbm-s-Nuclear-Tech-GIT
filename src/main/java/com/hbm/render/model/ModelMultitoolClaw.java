...
public class ModelMultitoolClaw extends ModelBase {
	...
	public ModelMultitoolClaw() {
		...
		setRotation(this.F31, 0F, 0F, ((float)Math.PI * 2F / 9F));
		...
		setRotation(this.F21, 0F, 0F, ((float)Math.PI * 2F / 9F));
		...
		setRotation(this.F41, 0F, 0F, ((float)Math.PI * 2F / 9F));
		...
		setRotation(this.F51, 0F, 0F, ((float)Math.PI * 2F / 9F));
		...
		setRotation(this.F12, 0F, ((float)Math.PI / 4F), 1.047198F);
		...
		setRotation(this.F13, ((float)Math.PI * 2F / 9F), 1.047198F, 1.047198F);
