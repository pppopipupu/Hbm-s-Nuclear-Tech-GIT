...
public class PUREXRecipes extends GenericRecipes<PUREXRecipe> {
	...
	public void registerDefaults() {
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.zirnoxnu").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.zirnoxmeu").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.zirnoxthmeu").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.zirnoxmox").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.zirnoxmep").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.zirnoxheu233").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.zirnoxheu235").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.zirnoxles").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.zirnoxzfbmox").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.platemox").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.platepu238be").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.platepu239").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.platera226be").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.platesa326").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.plateu233").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.plateu235").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrmeu").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrheu233").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrheu235").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrmen").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrhen237").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrmox").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrmep").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrhep239").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrhep241").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrmea").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrhea242").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrhes326").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrhes327").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrbfbam").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.pwrbfbpu241").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.watzschrab").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.watzhes").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.watzmes").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.watzles").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.watzhen").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.watzmep").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.watzlead").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.watzboron").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.watzdu").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		if(naquadriaNuggets.size() != 0) {
			...
			this.register((PUREXRecipe) new PUREXRecipe("purex.watznaqadah").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
			...
			this.register((PUREXRecipe) new PUREXRecipe("purex.watznaqadria").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		//ICF
		this.register((PUREXRecipe) new PUREXRecipe("purex.icf").setup(240, 10_000).setNameWrapper("purex.recycle")
		...
		/// Vitrification
		this.register((PUREXRecipe) new PUREXRecipe("purex.vitliquid").setup(80, vitrification)
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.vitgaseous").setup(80, vitrification)
				.inputItems(new ComparableStack(ModBlocks.sand_mix, 1, EnumSandType.LEAD))
				.inputFluids(new FluidStack(Fluids.WASTEGAS, 1_000))
				.outputItems(new ItemStack(ModItems.nuclear_waste_vitrified)));
		
		this.register((PUREXRecipe) new PUREXRecipe("purex.vitsolid").setup(80, vitrification)
		...
		// Schrabidium
		this.register((PUREXRecipe) new PUREXRecipe("purex.schraranium").setup(160, 1_000).setNameWrapper("purex.schrab")
		...
		this.register((PUREXRecipe) new PUREXRecipe("purex.schrabzirnox").setup(160, 50_000).setNameWrapper("purex.schrab").setGroup(autoSchrab, this)
				.inputItems(new ComparableStack(ModItems.waste_plutonium))
				...
				.outputItems(new ItemStack(ModItems.powder_schrabidium, 1),
						...
						new ItemStack(ModItems.nuclear_waste_tiny, 4))
				.setIconToFirstIngredient());
		this.register((PUREXRecipe) new PUREXRecipe("purex.schrabpwr").setup(160, 50_000).setNameWrapper("purex.schrab").setGroup(autoSchrab, this)
				.inputItems(new ComparableStack(ModItems.pwr_fuel_depleted, 1, EnumPWRFuel.MEP))
				.inputFluids(new FluidStack(Fluids.SOLVENT, 4_000), new FluidStack(Fluids.SCHRABIDIC, 250))
				.outputItems(new ItemStack(ModItems.powder_schrabidium, 1),
						new ItemStack(ModItems.nugget_technetium, 3),
						new ItemStack(ModItems.nuclear_waste_tiny, 4))
				.setIconToFirstIngredient());
		this.register((PUREXRecipe) new PUREXRecipe("purex.schrabmen").setup(160, 50_000).setNameWrapper("purex.schrab").setGroup(autoSchrab, this)
				.inputItems(new ComparableStack(ModItems.pwr_fuel_depleted, 1, EnumPWRFuel.MEN))
				.inputFluids(new FluidStack(Fluids.SOLVENT, 4_000), new FluidStack(Fluids.SCHRABIDIC, 250))
				.outputItems(new ItemStack(ModItems.powder_schrabidium, 1),
						new ItemStack(ModItems.nugget_technetium, 3),
