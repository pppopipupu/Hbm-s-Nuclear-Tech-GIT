...
public class CentrifugeRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		recipes.put(new ComparableStack(ModItems.crystal_copper), new ItemStack[] { new ItemStack(ModItems.powder_copper, 4), new ItemStack(ModItems.sulfur, 1), new ItemStack(ModItems.powder_cobalt_tiny, 1), new ItemStack(ModItems.powder_gold, 2) });
