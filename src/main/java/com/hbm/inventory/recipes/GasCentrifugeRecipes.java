...
public class GasCentrifugeRecipes {
	...
	public static void register() {
		...
		gasCent.put(new FluidStack(1000, Fluids.WATZ), new Object[] { new ItemStack[] {new ItemStack(ModItems.powder_iron, 4), new ItemStack(ModItems.powder_lead, 4), new ItemStack(ModItems.nuclear_waste_tiny, 1), new ItemStack(ModItems.dust, 8)}, false, 2 });
